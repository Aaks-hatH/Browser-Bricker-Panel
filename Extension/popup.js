...
async function loadStatus() {
    try {
        ...
        // Update lock status - FIXED: Check fail-closed first
        if (response.failClosedLocked) {
            statusBadge.textContent = 'FAIL-CLOSED';
            statusBadge.className = 'badge badge-warning';
            securityIndicator.className = 'security-indicator warning';
            securityText.textContent = '⚠️ Locked - Connection Lost';
        } else if (response.armed) {
...
// Initialize
loadStatus();// Enhanced Popup Script for Device Lockdown Extension v4.0
